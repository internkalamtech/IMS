...
export default function AdminDashboard() {
  ...
  // ✅ UPDATED STATS
  const stats = [
    { title: 'Total Students', value: data.total_users ?? 1250, icon: 'people', color: '#fff' },
    { title: 'Total Teachers', value: data.active_users ?? 0, icon: 'school', color: '#fff' },
    { title: 'Total Courses', value: data.total_courses ?? 15, icon: 'book', color: '#fff' },
    { title: 'Revenue', value: data.revenue ?? 50000, icon: 'cash', color: '#fff' },
  ];
