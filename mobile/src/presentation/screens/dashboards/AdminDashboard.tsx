  ...
  async function handleSubmit(): Promise<void> {
    ...
    try {
      ...
      if (!res.ok) {
        ...
        throw new Error(errorBody || 'Server error');
      }
      ...
      Alert.alert('Error', 'Unable to save user. Please try again.');
    } finally {
          ...
          <SafeAreaView edges={['top']}>
            <View style={styles.headerContent}>
              ...
              <TouchableOpacity onPress={() => setModalVisible(true)} style={styles.addIcon}>
                <Ionicons name="person-add" size={24} color={theme.colors.primaryForeground} />
              </TouchableOpacity>
...
const styles = StyleSheet.create({
  ...
  headerContent: { flexDirection: 'row', justifyContent: 'space-between', alignItems: 'center', paddingHorizontal: 24, paddingTop: 20, paddingBottom: 24 },
  ...
  statIconContainer: { width: 44, height: 44, borderRadius: 22, backgroundColor: 'rgba(255,255,255,0.2)', justifyContent: 'center', alignItems: 'center' },
  bannerStatValue: { fontSize: 22, fontWeight: '700' },
  bannerStatTitle: { fontSize: 12 },
  mainContent: { flex: 1, marginTop: 0, borderTopLeftRadius: 32, borderTopRightRadius: 32, paddingHorizontal: 24, paddingTop: 32 },
  sectionHeader: { flexDirection: 'row', alignItems: 'center', marginBottom: 20 },
  sectionTitle: { fontSize: 20, fontWeight: '700' },
  badge: { backgroundColor: '#2563eb', paddingHorizontal: 10, paddingVertical: 4, borderRadius: 12, marginLeft: 12 },
  ...
  updateIcon: { width: 48, height: 48, borderRadius: 14, justifyContent: 'center', alignItems: 'center', marginRight: 16 },
