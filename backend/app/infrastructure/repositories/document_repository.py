"""
Document repository for handling database operations related to compliance documents.
"""
...
class DocumentRepository:
    ...
    async def update(self, document: DocumentModel, update_data: dict) -> DocumentModel:
        """
