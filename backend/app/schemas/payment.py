"""
Pydantic schemas for the Payment Module API.

These schemas validate request bodies and shape response payloads for all
...
# ------------------------------------------------------------------ #
# Type aliases (shared with domain layer)
# ------------------------------------------------------------------ #
